...
@Component({
  selector: 'app-addpayrolldeductionmodel',
  templateUrl: './addpayrolldeductionmodel.component.html',
  styleUrls: ['./addpayrolldeductionmodel.component.scss'],
})
export class AddpayrolldeductionmodelComponent implements OnInit {
