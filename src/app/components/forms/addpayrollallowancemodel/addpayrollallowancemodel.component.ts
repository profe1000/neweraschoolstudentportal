...
@Component({
  selector: 'app-addpayrollallowancemodel',
  templateUrl: './addpayrollallowancemodel.component.html',
  styleUrls: ['./addpayrollallowancemodel.component.scss'],
})
export class AddpayrollallowancemodelComponent implements OnInit {
