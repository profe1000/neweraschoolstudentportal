...
@Component({
  selector: 'app-editpayrollallowancemodel',
  templateUrl: './editpayrollallowancemodel.component.html',
  styleUrls: ['./editpayrollallowancemodel.component.scss'],
})
export class EditpayrollallowancemodelComponent implements OnInit {
