...
@Component({
  selector: 'app-addsupplementaryincome',
  templateUrl: './addsupplementaryincome.component.html',
  styleUrls: ['./addsupplementaryincome.component.scss'],
})
export class AddsupplementaryincomeComponent implements OnInit {
