...
export class EditquizComponent implements OnInit {
 ...
 async loadpost(){
  ...
  .subscribe(async res => {
    ...
    if(res["statuscode"] == 100){
      ...
      this.title= res["post"][0]["title"]
      this. tag=  res["post"][0]["tag"]
      this.content=  res["post"][0]["post"]
      this. quizindex =  res["post"][0]["quizindex"]
      this. quizsubindex =  res["post"][0]["quizsubindex"]
      this. quizindexgroup =  res["post"][0]["quizindexgroup"]
      this. quizid =  res["post"][0]["quizid"]
      this. publishedstatus = res["post"][0]["publishedstatus"]
      }
 ...
 async proceed(){
  ...
  this.processingmsg="";
   ...
   await this.httpClient
      .post(this.generalservice.apiurl+ this.generalservice.editonlinequiz,jsonData)
      .subscribe(async res => {
