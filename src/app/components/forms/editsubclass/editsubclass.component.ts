...
@Component({
  selector: 'app-editsubclass',
  templateUrl: './editsubclass.component.html',
  styleUrls: ['./editsubclass.component.scss'],
})
export class EditsubclassComponent implements OnInit {
