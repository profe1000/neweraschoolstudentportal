...
@Component({
  selector: 'app-editpayrolldeductionmodel',
  templateUrl: './editpayrolldeductionmodel.component.html',
  styleUrls: ['./editpayrolldeductionmodel.component.scss'],
})
export class EditpayrolldeductionmodelComponent implements OnInit {
