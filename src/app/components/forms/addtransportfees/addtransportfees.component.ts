...
@Component({
  selector: 'app-addtransportfees',
  templateUrl: './addtransportfees.component.html',
  styleUrls: ['./addtransportfees.component.scss'],
})
export class AddtransportfeesComponent implements OnInit {
