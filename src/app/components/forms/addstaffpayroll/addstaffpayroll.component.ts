...
@Component({
  selector: 'app-addstaffpayroll',
  templateUrl: './addstaffpayroll.component.html',
  styleUrls: ['./addstaffpayroll.component.scss'],
})
export class AddstaffpayrollComponent implements OnInit {
