...
@Component({
  selector: 'app-addfeespayment',
  templateUrl: './addfeespayment.component.html',
  styleUrls: ['./addfeespayment.component.scss'],
})
export class AddfeespaymentComponent implements OnInit {
