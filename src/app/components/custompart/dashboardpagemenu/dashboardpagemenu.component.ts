...
@Component({
  selector: 'app-dashboardpagemenu',
  templateUrl: './dashboardpagemenu.component.html',
  styleUrls: ['./dashboardpagemenu.component.scss'],
})
export class DashboardpagemenuComponent implements OnInit {
  ...
  constructor(public http: HttpClient,public toastController: ToastController,private router: Router,) {
