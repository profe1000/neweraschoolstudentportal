...
import { ViewassignentdetailsComponent } from './getviews/viewassignentdetails/viewassignentdetails.component';
...
@NgModule({
  declarations: [HeaderComponent,FooterComponent,
    SetpasswordcompComponent, SetprofilecompComponent, 
    UploaddpComponent,UploadidComponent,GesturebasicComponent, 
    DownloadfileComponent,DownloadlistComponent,DownloadprogressComponent,DownloadviewerComponent,GeneraluploadComponent,GeneraldownloadComponent,GeneraluploadimageComponent,GeneraluploadimagemultipleComponent,SelectservercompComponent,
    QuizeditorComponent,QuizviewerComponent,QuizviewergameComponent,QuizviewerstudyComponent, NoteeditorComponent, NoteviewerComponent, ResulteditorComponent,ResultviewerComponent,
   CalendarviewerComponent,SessionnresultComponent,SchoolinfoComponent,
   ViewstudentsComponent,ViewteachersComponent,ViewsparentsComponent,ViewclassesComponent,ViewsubclassesComponent,ViewcoursesComponent,
  ViewsessionsComponent,ViewmessagesComponent,ViewsfeesmanagementComponent,ViewfeespaymentComponent,ViewtransportroutesComponent,ViewtransportfeesComponent,
ViewgoodsComponent,ViewstocksComponent,ViewsalesComponent,ViewexpensesComponent,ViewsuppincomeComponent,ViewpayrollComponent,ViewsamplesComponent,VieweventsComponent,ViewtransactionlogComponent,
AddstudentsComponent,AddteachersComponent,AddparentsComponent,AddclassComponent,AddsubclassComponent,AddcourseComponent,AddsubclassComponent,
AddsessionComponent,AddmessageComponent,
EditstudentsComponent,EditteacherComponent,EditparentComponent,EditclassComponent,EditsubclassComponent,EditcourseComponent,EditsessionComponent,
AddfeesComponent,AddfeespaymentComponent,AddexpensesComponent,AddgoodsComponent,AddsalesComponent,AddstocksComponent,AddsupplementaryincomeComponent,AddtransportfeesComponent,
AddtransportrouteComponent,EdittransportrouteComponent,EditgoodsComponent,AddblogpostComponent,AddbookauthorComponent,AddbookborrowerrequestComponent,AddbookcategoryComponent,
AddbookpublisherComponent,AddbookregisterborrowerComponent,AddbooktolibraryComponent,AddonlinebookComponent,AddschooleventsComponent,AddvideosComponent,
  EditblogpostComponent,EditbookauthorComponent,EditbookcategoryComponent,EditbookpublisherComponent,EditlibrarybookComponent,EditonlinebookComponent,EditschooleventsComponent,
EditvideosComponent,AddadminComponent,EditadminComponent,AddpinsComponent,AddstaffpayrollComponent,VieweventhomeComponent,ViewtransactionloghomeComponent, ViewstudentheaderComponent, ViewparentheaderComponent,ViewteacherheaderComponent,AutocompserverComponent
 ,ViewresultsComponent,AddquizComponent,EditquizComponent,ViewquizComponent,ViewstudentbodyComponent,ViewteacherbodyComponent,ViewparentbodyComponent,
 ViewstudentfeesComponent, ViewstudentfeeslistComponent,ViewstockcartComponent,ViewsalescartComponent,ViewsexpensescartComponent,ViewstaffpaymentComponent,ViewpayrollallowancemodelComponent,ViewpayrollallowancestaffComponent,ViewpayrolldeductionmodelComponent,ViewpayrolldeductionstaffComponent,
AddpayrollallowancemodelComponent,AddpayrolldeductionmodelComponent,EditpayrollallowancemodelComponent,EditpayrolldeductionmodelComponent, AddsalesviewComponent,ViewvideosComponent,ViewpostsComponent,AddfeespaymentviewComponent,DashboardpagemenuComponent,ResulteditorsubjectComponent,
ViewcreateresultsheetComponent,ViewquizhistoryComponent,ViewschoolfeespaymentcreateComponent, AutocompserverparentsComponent,AutocompserverteacherComponent,AutocompserverstudentComponent,ResultviewerprintComponent,
ViewassignmentComponent,ViewassignentdetailsComponent,ViewnotesComponent,ViewnotesdetailsComponent],
  imports: [
    CommonModule, 
    IonicModule,
    RouterModule,
