...
@NgModule({
  declarations: [HeaderComponent,FooterComponent,
    ...
    DownloadfileComponent,DownloadlistComponent,DownloadprogressComponent,DownloadviewerComponent,GeneraluploadComponent,GeneraldownloadComponent,GeneraluploadimageComponent,GeneraluploadimagemultipleComponent,SelectservercompComponent,SelectservercomparraysComponent,
...
ViewcreateresultsheetComponent,ViewquizhistoryComponent,ViewschoolfeespaymentcreateComponent, AutocompserverparentsComponent,AutocompserverteacherComponent,AutocompserverstudentComponent,
ViewassignmentComponent,
ViewnotesComponent, ViewnotesdetailsComponent,ViewassignmentdetailsComponent,AddassignmentanswerComponent, ViewvideossingleComponent],
  imports: [
    CommonModule, 
    IonicModule,
    RouterModule,
