...
@Component({
  selector: 'app-addschoolevents',
  templateUrl: './addschoolevents.component.html',
  styleUrls: ['./addschoolevents.component.scss'],
})
export class AddschooleventsComponent implements OnInit {
