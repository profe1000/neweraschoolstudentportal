...
@Component({
  selector: 'app-addonlinebook',
  templateUrl: './addonlinebook.component.html',
  styleUrls: ['./addonlinebook.component.scss'],
})
export class AddonlinebookComponent implements OnInit {
