...
@Component({
  selector: 'app-addbookborrowerrequest',
  templateUrl: './addbookborrowerrequest.component.html',
  styleUrls: ['./addbookborrowerrequest.component.scss'],
})
export class AddbookborrowerrequestComponent implements OnInit {
