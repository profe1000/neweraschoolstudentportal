...
@Component({
  selector: 'app-editlibrarybook',
  templateUrl: './editlibrarybook.component.html',
  styleUrls: ['./editlibrarybook.component.scss'],
})
export class EditlibrarybookComponent implements OnInit {
