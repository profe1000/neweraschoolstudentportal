...
@Component({
  selector: 'app-editonlinebook',
  templateUrl: './editonlinebook.component.html',
  styleUrls: ['./editonlinebook.component.scss'],
})
export class EditonlinebookComponent implements OnInit {
