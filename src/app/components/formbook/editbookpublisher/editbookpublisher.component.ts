...
@Component({
  selector: 'app-editbookpublisher',
  templateUrl: './editbookpublisher.component.html',
  styleUrls: ['./editbookpublisher.component.scss'],
})
export class EditbookpublisherComponent implements OnInit {
