...
@Component({
  selector: 'app-editbookauthor',
  templateUrl: './editbookauthor.component.html',
  styleUrls: ['./editbookauthor.component.scss'],
})
export class EditbookauthorComponent implements OnInit {
