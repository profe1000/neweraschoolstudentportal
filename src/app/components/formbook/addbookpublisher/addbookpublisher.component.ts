...
@Component({
  selector: 'app-addbookpublisher',
  templateUrl: './addbookpublisher.component.html',
  styleUrls: ['./addbookpublisher.component.scss'],
})
export class AddbookpublisherComponent implements OnInit {
