...
@Component({
  selector: 'app-editschoolevents',
  templateUrl: './editschoolevents.component.html',
  styleUrls: ['./editschoolevents.component.scss'],
})
export class EditschooleventsComponent implements OnInit {
