...
@Component({
  selector: 'app-addbookregisterborrower',
  templateUrl: './addbookregisterborrower.component.html',
  styleUrls: ['./addbookregisterborrower.component.scss'],
})
export class AddbookregisterborrowerComponent implements OnInit {
