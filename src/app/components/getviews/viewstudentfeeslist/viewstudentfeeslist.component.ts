...
@Component({
  selector: 'app-viewstudentfeeslist',
  templateUrl: './viewstudentfeeslist.component.html',
  styleUrls: ['./viewstudentfeeslist.component.scss'],
})
export class ViewstudentfeeslistComponent implements OnInit {
...
loadmyeditfunction(pageindex){
  this.loadeditfunction.emit(this.featurepost[pageindex].specificfeesid);
