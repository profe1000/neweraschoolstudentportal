...
export class ViewnotesComponent implements OnInit {
 ...
 async loadinit(){
  ...
  geturl(){
    console.log(this.generalservice.apiurl + this.generalservice.viewnote +"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"")
    let defaulturl = this.generalservice.apiurl + this.generalservice.viewnote +"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"";
     return defaulturl; 
  }
...
if($event.target.value==1){
   ...
   //this.router.navigate(["/quizpageeditor/" + this.featurepost[pageindex].noteid +'/' + this.featurepost[pageindex].quizurl])
...
async deletefile(index){
 ...
 //this.startloading();
  ...
  await this.httpClient
     .get(this.generalservice.apiurl + ""+ "?userid=1&noteid="+ this.featurepost[index].noteid +"")
     .subscribe(async res => {
...
async confirmfile(index){
  ...
  // the post obj
  var obj = {
    "noteid":this.featurepost[index].noteid,
    "orderstatuscode":1,
    "itemnum":1,
    "apikey":"",
          };
...
loadmyeditfunction(pageindex){
  this.loadeditfunction.emit(this.featurepost[pageindex].noteid);
  //alert(this.featurepost[pageindex].noteid)
}

loadmyorderdispatch(pageindex){
  this.loadorderdespatch.emit(this.featurepost[pageindex].noteid);
}

loadmyordermessage(pageindex){
  this.loadordermessage.emit(this.featurepost[pageindex].noteid);
}
