...
export class ViewquizComponent implements OnInit {
 ...
 async loadinit(){
  ...
  geturl(){
    console.log(this.generalservice.apiurl + this.generalservice.onlinequiz +"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"")
    let defaulturl = this.generalservice.apiurl + this.generalservice.onlinequiz +"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"";
     return defaulturl; 
  }
...
async loadsyncpost(){
  ...
  openpage(pageindex){
    this.router.navigate(['quizsingle/' + this.featurepost[pageindex].quizid +'/' + this.featurepost[pageindex].quizurl]);
  }
...
if($event.target.value==1){
   ...
   this.router.navigate(["/quizpageeditor/" + this.featurepost[pageindex].quizid +'/' + this.featurepost[pageindex].quizurl])
...
async deletefile(index){
 ...
 //this.startloading();
  ...
  await this.httpClient
     .get(this.generalservice.apiurl + this.generalservice.deleteonlinequiz+ "?userid=1&quizid="+ this.featurepost[index].quizid +"")
     .subscribe(async res => {
...
async confirmfile(index){
  ...
  // the post obj
  var obj = {
    "quizid":this.featurepost[index].quizid,
    "orderstatuscode":1,
    "itemnum":1,
    "apikey":"",
          };
...
loadmyeditfunction(pageindex){
  this.loadeditfunction.emit(this.featurepost[pageindex].quizid);
  //alert(this.featurepost[pageindex].quizid)
}

loadmyorderdispatch(pageindex){
  this.loadorderdespatch.emit(this.featurepost[pageindex].quizid);
}

loadmyordermessage(pageindex){
  this.loadordermessage.emit(this.featurepost[pageindex].quizid);
}
