...
@Component({
  selector: 'app-viewtransactionlog',
  templateUrl: './viewtransactionlog.component.html',
  styleUrls: ['./viewtransactionlog.component.scss'],
})
export class ViewtransactionlogComponent implements OnInit {
