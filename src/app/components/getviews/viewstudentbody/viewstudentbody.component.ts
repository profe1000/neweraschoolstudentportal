...
@Component({
  selector: 'app-viewstudentbody',
  templateUrl: './viewstudentbody.component.html',
  styleUrls: ['./viewstudentbody.component.scss'],
})
export class ViewstudentbodyComponent implements OnInit {
  Surname:any;
  Firstname:any;
  Middlename:any;
  Nationality:any;
 ...
 async loadpost(){
  ...
  .subscribe(async res => {
    ...
    if(res["statuscode"] == 100){
     ...
     this.Surname=res["post"][0]["studentSurname"]
     this.Firstname=res["post"][0]["studentFirstname"]
     this.Middlename=res["post"][0]["studentMiddlename"]
     this.Nationality=res["post"][0]["studentNationality"]
     this.state=res["post"][0]["studentstate"]
     this.localovernment=res["post"][0]["studentlocalgovernment"]
     ...
     this.Studentcategory=res["post"][0]["studentcategory"]
     ...
     this.Entryclass=res["post"][0]["initialclassid"]
     this.presentclass=res["post"][0]["subclassid"]
