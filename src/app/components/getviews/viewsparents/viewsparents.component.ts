...
@Component({
  selector: 'app-viewsparents',
  templateUrl: './viewsparents.component.html',
  styleUrls: ['./viewsparents.component.scss'],
})
export class ViewsparentsComponent implements OnInit {
