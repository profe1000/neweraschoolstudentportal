...
@Component({
  selector: 'app-viewassignentdetails',
  templateUrl: './viewassignentdetails.component.html',
  styleUrls: ['./viewassignentdetails.component.scss'],
})
export class ViewassignentdetailsComponent implements OnInit {
 ...
 async loadinit(){
  ...
  geturl(){
    console.log(this.generalservice.apiurl+ this.generalservice.viewassignmentanswer+"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"")
    let defaulturl = this.generalservice.apiurl+ this.generalservice.viewassignmentanswer +"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"";
     return defaulturl; 
  }
...
loadtotalprice(){
  ...
  for(var i=0; i <  this.featurepost.length; i++){
    this.price = this.price +  ((this.featurepost[i].sellingprice  * this.featurepost[i].quantity))
  }
}
