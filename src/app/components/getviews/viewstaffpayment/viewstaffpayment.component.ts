...
@Component({
  selector: 'app-viewstaffpayment',
  templateUrl: './viewstaffpayment.component.html',
  styleUrls: ['./viewstaffpayment.component.scss'],
})
export class ViewstaffpaymentComponent implements OnInit {
