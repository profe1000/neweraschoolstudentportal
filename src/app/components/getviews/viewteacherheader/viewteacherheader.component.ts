...
@Component({
  selector: 'app-viewteacherheader',
  templateUrl: './viewteacherheader.component.html',
  styleUrls: ['./viewteacherheader.component.scss'],
})
export class ViewteacherheaderComponent implements OnInit {
  ...
  @Input() storagekey: string = 'Teachers';
  ...
  teacherstatus=["<span class='w3-text-orange w3-round'> Pending </span>", "<span class='w3-text-green  w3-round'> Active  </span>","<span class='w3-text-blue  w3-round'> Graduated </span>","<span class='w3-text-pale-green  w3-round'> Archive </span>","<span class='w3-text-red'> Deleted </span>"]
  paymentstatus=["Not Paid","Paid"];

  loading:any;

  orderfilter:any="0";
  orderfiltername:any="All Teachers";
  orderfilternamearray=["All Teachers", "Pending Orders","Confirm Orders","Transist Orders","Delivered Orders","Rejected Orders"]
 ...
 async loadinit(){
  ...
  geturl(){
    console.log(this.generalservice.apiurl + this.generalservice.vieteacherapi+"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"")
    let defaulturl = this.generalservice.apiurl + this.generalservice.vieteacherapi+"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"";
     return defaulturl; 
  }
...
if($event.target.value==1){
   ...
   alert("View Teacher function not ready")
} else if($event.target.value==3){
  alert("Delete Teacher function not ready")
} else if($event.target.value==4){
  alert("Archived Teacher function not ready")
} else if($event.target.value==5){
  alert("Approved Teacher function not ready")
} 
}
