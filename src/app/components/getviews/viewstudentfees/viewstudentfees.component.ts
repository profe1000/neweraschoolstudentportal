...
@Component({
  selector: 'app-viewstudentfees',
  templateUrl: './viewstudentfees.component.html',
  styleUrls: ['./viewstudentfees.component.scss'],
})
export class ViewstudentfeesComponent implements OnInit {
...
loadmyeditfunction(pageindex){
  this.loadeditfunction.emit(this.featurepost[pageindex].studentid);
