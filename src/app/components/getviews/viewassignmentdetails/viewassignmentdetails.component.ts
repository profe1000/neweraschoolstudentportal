...
@Component({
  selector: 'app-viewassignmentdetails',
  templateUrl: './viewassignmentdetails.component.html',
  styleUrls: ['./viewassignmentdetails.component.scss'],
})
export class ViewassignmentdetailsComponent implements OnInit {
