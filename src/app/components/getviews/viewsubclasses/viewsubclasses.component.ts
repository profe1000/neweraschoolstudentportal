...
@Component({
  selector: 'app-viewsubclasses',
  templateUrl: './viewsubclasses.component.html',
  styleUrls: ['./viewsubclasses.component.scss'],
})
export class ViewsubclassesComponent implements OnInit {
