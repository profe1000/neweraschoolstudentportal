...
@Component({
  selector: 'app-viewteacherbody',
  templateUrl: './viewteacherbody.component.html',
  styleUrls: ['./viewteacherbody.component.scss'],
})
export class ViewteacherbodyComponent implements OnInit {
