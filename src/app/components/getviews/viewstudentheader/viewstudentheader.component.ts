...
@Component({
  selector: 'app-viewstudentheader',
  templateUrl: './viewstudentheader.component.html',
  styleUrls: ['./viewstudentheader.component.scss'],
})
export class ViewstudentheaderComponent implements OnInit {
