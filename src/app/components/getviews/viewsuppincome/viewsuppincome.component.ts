...
@Component({
  selector: 'app-viewsuppincome',
  templateUrl: './viewsuppincome.component.html',
  styleUrls: ['./viewsuppincome.component.scss'],
})
export class ViewsuppincomeComponent implements OnInit {
