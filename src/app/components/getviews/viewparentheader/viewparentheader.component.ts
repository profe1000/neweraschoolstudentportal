...
@Component({
  selector: 'app-viewparentheader',
  templateUrl: './viewparentheader.component.html',
  styleUrls: ['./viewparentheader.component.scss'],
})
export class ViewparentheaderComponent implements OnInit {
  ...
  @Input() storagekey: string = 'Parents';
  ...
  Parentstatus=["<span class='w3-text-orange w3-round'> Pending </span>", "<span class='w3-text-green  w3-round'> Active  </span>","<span class='w3-text-blue  w3-round'> Graduated </span>","<span class='w3-text-pale-green  w3-round'> Archive </span>","<span class='w3-text-red'> Deleted </span>"]
  paymentstatus=["Not Paid","Paid"];

  loading:any;

  orderfilter:any="0";
  orderfiltername:any="All Parents";
  orderfilternamearray=["All Parents", "Pending Orders","Confirm Orders","Transist Orders","Delivered Orders","Rejected Orders"]
...
if($event.target.value==1){
   ...
   alert("View Parent function not ready")
} else if($event.target.value==3){
  alert("Delete Parent function not ready")
} else if($event.target.value==4){
  alert("Archived Parent function not ready")
} else if($event.target.value==5){
  alert("Approved Parent function not ready")
} 
}
