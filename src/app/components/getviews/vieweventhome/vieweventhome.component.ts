...
@Component({
  selector: 'app-vieweventhome',
  templateUrl: './vieweventhome.component.html',
  styleUrls: ['./vieweventhome.component.scss'],
})
export class VieweventhomeComponent implements OnInit {
