...
@Component({
  selector: 'app-viewschoolfeespaymentcreate',
  templateUrl: './viewschoolfeespaymentcreate.component.html',
  styleUrls: ['./viewschoolfeespaymentcreate.component.scss'],
})
export class ViewschoolfeespaymentcreateComponent implements OnInit {
 ...
 async loadinit(){
  ...
  geturl(){
    console.log(this.generalservice.apiurl + this.generalservice.viewstudentapi +"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"")
    let defaulturl = this.generalservice.apiurl + this.generalservice.viewstudentapi +"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"";
     return defaulturl; 
  }
...
openpage(pageindex){
  this.router.navigate(["/resultsingle/" + this.featurepost[pageindex].id +'/' + this.featurepost[pageindex].firstname])
}




async addspecificfees(index){
  // the post obj
  var obj = {
    "generalfeesid":this.generalfeesid,
    "studentid":this.featurepost[index].studentid,
    "amountoffees":"2000",
 ...
 var jsonData = JSON.stringify(obj);
    this.startloading("Please Wait Creating Invoice");
 
  await this.httpClient
     .post(this.generalservice.apiurl + this.generalservice.addspecificfees,jsonData)
     .subscribe(async res => {
        //Connection successful, once you read the data in res you use the status code to perform logic
       console.log(res);
 ...
 getourselectdfeesvalue($event){
  this.generalfeesid = $event
}
