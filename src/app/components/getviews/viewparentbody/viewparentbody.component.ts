...
@Component({
  selector: 'app-viewparentbody',
  templateUrl: './viewparentbody.component.html',
  styleUrls: ['./viewparentbody.component.scss'],
})
export class ViewparentbodyComponent implements OnInit {
  title:any;
  Surname:any;
  Firstname:any;
  Middlename:any;
