...
@Component({
  selector: 'app-viewquizhistory',
  templateUrl: './viewquizhistory.component.html',
  styleUrls: ['./viewquizhistory.component.scss'],
})
export class ViewquizhistoryComponent implements OnInit {
