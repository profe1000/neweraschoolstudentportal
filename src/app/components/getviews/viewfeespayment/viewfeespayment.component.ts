...
@Component({
  selector: 'app-viewfeespayment',
  templateUrl: './viewfeespayment.component.html',
  styleUrls: ['./viewfeespayment.component.scss'],
})
export class ViewfeespaymentComponent implements OnInit {
  ...
  @Input() qstringe: string = '';
  @Input() qstringf: string = '';
  @Input() userid: string = '';
  @Input() postid: string = '';
 ...
 async loadinit(){
  ...
  geturl(){
    console.log(this.generalservice.apiurl + this.generalservice.viewfeespaymentapi+"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&qstringe="+ this.qstringe +"&qstringf="+ this.qstringf +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"")
    let defaulturl = this.generalservice.apiurl + this.generalservice.viewfeespaymentapi+"?updatetype="+ this.updatetype +"&userid="+ this.userid +"&postid="+ this.postid  +"&qstring="+ this.qstring +"&qstringb="+ this.qstringb +"&qstringc="+ this.qstringc +"&qstringd="+ this.qstringd +"&qstringe="+ this.qstringe +"&qstringf="+ this.qstringf +"&pageNum="+ this.pagenum+"&pageSize="+ this.pagesize+"";
     return defaulturl; 
  }
