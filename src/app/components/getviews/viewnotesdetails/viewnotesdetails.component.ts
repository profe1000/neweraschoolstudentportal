...
@Component({
  selector: 'app-viewnotesdetails',
  templateUrl: './viewnotesdetails.component.html',
  styleUrls: ['./viewnotesdetails.component.scss'],
})
export class ViewnotesdetailsComponent implements OnInit {
