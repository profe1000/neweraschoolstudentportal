...
@Component({
  selector: 'app-viewcreateresultsheet',
  templateUrl: './viewcreateresultsheet.component.html',
  styleUrls: ['./viewcreateresultsheet.component.scss'],
})
export class ViewcreateresultsheetComponent implements OnInit {
...
async createnewresult(index){
  ...
  var obj = {
    ...
    "subclassid":this.featurepost[index].subclassid,
    "classid":this.featurepost[index].classid,
    "classarmid":this.featurepost[index].classarmid,
 ...
 var jsonData = JSON.stringify(obj);
  ...
  await this.httpClient
     .post(this.generalservice.apiurl + this.generalservice.createresultsheet,jsonData)
     .subscribe(async res => {
        //Connection successful, once you read the data in res you use the status code to perform logic
       console.log(res);
