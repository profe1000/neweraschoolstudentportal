...
@Component({
  selector: 'app-generalupload',
  templateUrl: './generalupload.component.html',
  styleUrls: ['./generalupload.component.scss'],
})
export class GeneraluploadComponent implements OnInit {
