...
@Component({
  selector: 'app-autocompserverteacher',
  templateUrl: './autocompserverteacher.component.html',
  styleUrls: ['./autocompserverteacher.component.scss'],
})
export class AutocompserverteacherComponent implements OnInit {
