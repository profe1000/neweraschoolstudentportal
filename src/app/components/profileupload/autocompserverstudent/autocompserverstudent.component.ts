...
@Component({
  selector: 'app-autocompserverstudent',
  templateUrl: './autocompserverstudent.component.html',
  styleUrls: ['./autocompserverstudent.component.scss'],
})
export class AutocompserverstudentComponent implements OnInit {
