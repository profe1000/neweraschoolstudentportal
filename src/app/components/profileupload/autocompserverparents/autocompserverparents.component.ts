...
@Component({
  selector: 'app-autocompserverparents',
  templateUrl: './autocompserverparents.component.html',
  styleUrls: ['./autocompserverparents.component.scss'],
})
export class AutocompserverparentsComponent implements OnInit {
