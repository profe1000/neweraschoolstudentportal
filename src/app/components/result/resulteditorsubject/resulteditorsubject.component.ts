...
@Component({
  selector: 'app-resulteditorsubject',
  templateUrl: './resulteditorsubject.component.html',
  styleUrls: ['./resulteditorsubject.component.scss'],
})
export class ResulteditorsubjectComponent implements OnInit {
 ...
 calculatetotalscore(){
  ...
  this.averagescore =  this.overalltotal / this.resultdata.post.length;
